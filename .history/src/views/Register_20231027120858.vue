    ...
    <div class="mask">
      <el-form hide-required-asterisk ref="ruleFormRef" label-position="top" :model="userForm" :rules="rules" class="register-form" :size="formSize">
        ...
        <el-form-item prop="userSex" label="性别">
          <el-input v-model="userForm.userSex" :prefix-icon="Avatar" size="large" auto-complete="off" placeholder="性别" :style="{ fontSize: '16px' }" />
        </el-form-item>
        ...
        <el-form-item prop="password" label="确认密码">
          <el-input v-model="userForm.confirmPassword" type="password" :prefix-icon="Lock" size="large" auto-complete="off" placeholder="确认密码" :style="{ fontSize: '16px' }" />
        </el-form-item>
        <el-form-item prop="userPhone" label="联系电话">
          <el-input v-model="userForm.userPhone" type="phone" :prefix-icon="Lock" size="large" auto-complete="off" placeholder="联系电话" :style="{ fontSize: '16px' }" />
        </el-form-item>
        <el-form-item prop="password" label="邮箱">
          <el-input v-model="userForm.userEmail" type="email" :prefix-icon="Lock" size="large" auto-complete="off" placeholder="邮箱" :style="{ fontSize: '16px' }" />
        </el-form-item>
        <el-form-item prop="userAvatar" label="头像">
          <el-input v-model="userForm.userAvatar" :prefix-icon="Lock" size="large" auto-complete="off" placeholder="头像" :style="{ fontSize: '16px' }" />
        </el-form-item>
        <el-form-item prop="userBio" label="个人简介">
          <el-input v-model="userForm.userBio" :prefix-icon="Lock" size="large" auto-complete="off" placeholder="个人简介" :style="{ fontSize: '16px' }" />
        </el-form-item>
...
<style scoped lang="scss">
  ...
  .el-link:hover,:deep(.el-tabs__item.is-active), :deep(.el-tabs__item:hover) {
