            ...
            <div class="hengxi-nei">
              ...
              <div class="nei-account">
                ...
                <el-form-item class="register">
                  <el-button size="large" color="#7b1e1796" :dark="isDark" class="btn_register" @click="navigateToRegister()">去注册</el-button>
                </el-form-item>
              </div>
            </div>
          </div>
          <el-tabs v-model="activeName" class="demo-tabs">
            ...
            <el-tab-pane label="短信登录" name="sms">
              ...
              <el-form-item class="submit" id="login">
                <el-button size="large" color="#7b1e17" :dark="isDark" class="btn_login" :disabled="!userForm.disableclick" @click="submitForm(ruleFormRef)">登录</el-button>
              </el-form-item>
            </el-tab-pane>
          </el-tabs>
        </el-form>
