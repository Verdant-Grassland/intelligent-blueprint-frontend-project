      ...
      <el-tabs v-modal="activeName" class="demo-tabs" @tab-click="handleClick">
        ...
        <el-tab-pane label="短信登录" name="sms">
          ...
          <el-form-item prop="userCaptcha" class="userCaptcha-main" label="验证码">
            <el-input class="yzbox" v-model="userForm.userCaptcha" type="text" :prefix-icon="Lock" size="large" auto-complete="off" placeholder="验证码" placeholder-style="color: blue" :style="{ fontSize: '16px' }">
              <template #append>
                <el-link v-if="userForm.disableclick">{{ userForm.time }}</el-link>
...
:deep(.el-input-group__append) {
  background-color: #83ed0a !important;
  border-left:none !i;
}
</style>