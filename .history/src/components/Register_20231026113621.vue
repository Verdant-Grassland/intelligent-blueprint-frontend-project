    ...
    <div class="mask">
      <el-form hide-required-asterisk ref="ruleFormRef" label-position="top" :model="userForm" :rules="rules" class="register-form" :size="formSize">
        ...
        <el-form-item prop="userRename" label="姓名">
          <el-input v-model="userForm.userRename" :prefix-icon="Avatar" size="large" auto-complete="off" placeholder="性别" :style="{ fontSize: '16px' }" />
        </el-form-item>
        <el-form-item prop="userSex" label="性别">
          <el-input v-model="userForm.userSex" :prefix-icon="Avatar" size="large" auto-complete="off" placeholder="姓名" :style="{ fontSize: '16px' }" />
        </el-form-item>
