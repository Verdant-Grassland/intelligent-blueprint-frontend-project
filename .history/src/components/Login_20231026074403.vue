      ...
      <el-form hide-required-asterisk ref="ruleFormRef" label-position="top" :model="userForm" :rules="rules" class="login-form" :size="formSize">
        ...
        <el-tabs v-model="activeName" class="demo-tabs">
          ...
          <el-tab-pane label="短信登录" name="sms">
            ...
            <el-form-item class="submit">
              <el-button size="large" color="#7b1e17" :style="{ 'background-color': !userForm.disableclick ? '#ccc' : '#7b1e17' }" :dark="isDark" class="btn_login" id="login" :disabled="!userForm.disableclick" @click="submitForm(ruleFormRef)">登录</el-button>
            </el-form-item>
          </el-tab-pane>
        </el-tabs>
      </el-form>
