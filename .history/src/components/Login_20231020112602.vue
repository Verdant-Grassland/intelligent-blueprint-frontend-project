<template>
  <div class="login">
    ...
    <div class="mask">
      ...
      <el-form-item prop="loginIdentifier" label="用户名/邮箱/手机号">
        <el-input v-model="userForm.loginIdentifier" @input="userInput" :prefix-icon="Avatar" size="large" auto-complete="off" placeholder="用户名/邮箱/手机号" :style="{ fontSize: '16px' }" />
      </el-form-item>
...
<script lang="ts" setup>
  ...
  const rules = reactive<FormRules>({
    userName: [
      ...
      { min: 3, max: 20, message: '用户名的长度范围是 3 至 20 个字符', trigger: 'blur' }
    ],
    userPhone: [
