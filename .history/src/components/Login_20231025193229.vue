      ...
      <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
        ...
        <el-tab-pane label="短信登录" name="sms">
          <el-form-item prop="userPhone" label="手机号">
            <el-input v-model="userForm.userPhone" size="large" prefix-icon="el-icon-shouji" auto-complete="off" placeholder="请输入手机号" placeholder-style="color: green" :style="{ fontSize: '16px' }" />
          </el-form-item>
