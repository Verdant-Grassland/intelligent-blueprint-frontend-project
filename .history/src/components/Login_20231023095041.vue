    ...
    <div class="mask">
      ...
      <el-tables v-modal="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="短信登录" name="password">
          <el-form-item prop="userPhone" label="用户名/邮箱/手机号">
            <el-input v-model="userForm.userPhone" @input="userInput" :prefix-icon="Avatar" size="large" auto-complete="off" placeholder="用户名/邮箱/手机号" :style="{ fontSize: '16px' }" />
          </el-form-item>
        </el-tab-pane>
      </el-tables>
