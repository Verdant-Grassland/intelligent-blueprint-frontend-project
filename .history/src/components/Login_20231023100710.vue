    ...
    <div class="mask">
      <el-form hide-required-asterisk ref="ruleFormRef" label-position="top" :model="userForm" :rules="rules" class="login-form" :size="formSize">
        <el-tab-pane label="密码登录" name="password">
          <el-form ref="passwordForm" :model="userForm" :rules="passwordRules">
            <el-form-item prop="inputValue" label="用户名/邮箱/手机号">
              <el-input v-model="userForm.inputValue" :prefix-icon="Avatar" size="large" autocomplete="off" placeholder="用户名/邮箱/手机号" :style="{ fontSize: '16px' }" />
            </el-form-item>
            <el-form-item prop="password" label="密码">
              <el-input v-model="userForm.password" type="password" :prefix-icon="Lock" size="large" autocomplete="off" placeholder="密码" :style="{ fontSize: '16px' }" />
            </el-form-item>
        ...
        <el-tab-pane label="短信登录" name="sms">
          <el-form ref="smsForm" :model="userForm" :rules="smsRules">
            <el-form-item prop="userPhone" label="请输入手机号">
              <el-input v-model="userForm.userPhone" :prefix-icon="Iphone" size="large" autocomplete="off" placeholder="用户名/邮箱/手机号" :style="{ fontSize: '16px' }" />
            </el-form-item>
            <el-form-item prop="userCaptcha" label="验证码">
              <el-input v-model="userForm.userCaptcha" type="text" :prefix-icon="Lock" size="large" autocomplete="off" placeholder="验证码" :style="{ fontSize: '16px' }" />
            </el-form-item>
          </el-form>
        </el-tab-pane>
