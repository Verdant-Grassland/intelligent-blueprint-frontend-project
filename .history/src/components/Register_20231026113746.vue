    ...
    <div class="mask">
      <el-form hide-required-asterisk ref="ruleFormRef" label-position="top" :model="userForm" :rules="rules" class="register-form" :size="formSize">
        ...
        <el-form-item prop="userPhone" label="联系电话">
          <el-input v-model="userForm.userPhone" :prefix-icon="Lock" size="large" auto-complete="off" placeholder="联系电话" :style="{ fontSize: '16px' }" />
        </el-form-item>
        <el-form-item prop="password" label="邮箱">
          <el-input v-model="userForm.userEmail" type="password" :prefix-icon="Lock" size="large" auto-complete="off" placeholder="密码" :style="{ fontSize: '16px' }" />
        </el-form-item>
        <el-form-item prop="password" label="密码">
          <el-input v-model="userForm.password" type="password" :prefix-icon="Lock" size="large" auto-complete="off" placeholder="密码" :style="{ fontSize: '16px' }" />
        </el-form-item>
