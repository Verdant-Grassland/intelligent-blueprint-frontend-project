  ...
  <div class="login">
    ...
    <div class="mask">
      ...
      <el-form-item prop="inputValue" label="用户名/邮箱/手机号">
        <el-input v-model="userForm.inputValue" @input="userInput" :prefix-icon="Avatar" size="large" auto-complete="off" placeholder="用户名/邮箱/手机号" :style="{ fontSize: '16px', width: '16px' }" />
      </el-form-item>
