<template>
  <div class="bg-color" style="position: relative; z-index: 1;">
    <el-carousel :autoplay="false" height="400px">
      <el-carousel-item type="card" v-for="(item, index) in bannerList" :key="index">
        <div class="carousel" :style="{ 'background': `url(${item.bannerImage}) no-repeat center center / cover`, 'background-color': 'transparent' }">
