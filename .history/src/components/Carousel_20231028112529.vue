<template>
  <el-carousel :autoplay="false" height="400px">
     <el-carousel-item type="card" v-for="(item,index) in bannerList" :key="index">
        <div class="carousel" :style="{ 'background': `url(${item.bannerImage}) no-background: url(http://192.168.188.128:8888/group1/M00/00/07/wKi8gGUmLPeAPHtJAAuA_ztceqk652.jpg) no-repeat;` }">
