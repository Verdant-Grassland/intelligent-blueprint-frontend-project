    ...
    <div class="mask">
      <el-form hide-required-asterisk ref="ruleFormRef" label-position="top" :model="userForm" :rules="rules" class="register-form" :size="formSize">
          ...
          <el-tab-pane label="短信登录" name="sms">
            ...
            <el-form-item class="submit" id="register">
              <el-button size="large" color="#7b1e17" :dark="isDark" class="btn_register" :disabled="!userForm.disableclick" @click="submitForm(ruleFormRef)">登录</el-button>
            </el-form-item>
          </el-tab-pane>
        </el-tabs>
      </el-form>
