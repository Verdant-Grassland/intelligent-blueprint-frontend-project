<template>
  ...
  <div class="login">
    <div class="mask">
      ...
      <el-tables v-modal="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="短信登录" name="password">
          <el-form-item prop="userPhone" label="请输入手机号">
            <el-input v-model="userForm.userPhone" :prefix-icon="Iphone" size="large" auto-complete="off" placeholder="用户名/邮箱/手机号" :style="{ fontSize: '16px' }" />
          </el-form-item>
          <el-form-item prop="userCaptcha" label="密码">
            <el-input v-model="userForm.userCaptcha" type="password" :prefix-icon="Lock" size="large" auto-complete="off" placeholder="密码" :style="{ fontSize: '16px' }" />
          </el-form-item>
        </el-tab-pane>
      </el-tables>
