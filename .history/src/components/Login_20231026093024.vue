          ...
          <div class="hengxi-nei">
            ...
            <div class="nei-account">
              ...
              <el-form-item class="register">
                <el-button size="large" color="#7b1e1796" :dark="isDark" class="btn_register" @click="submitForm(ruleFormRef)">去注册</el-button>
              </el-form-item>
            </div>
          </div>
        </div>
        <el-tabs v-model="activeName" class="demo-tabs">
          ...
          <el-tab-pane label="短信登录" name="sms">
            <el-form-item prop="userPhone" label="手机号">
              <el-input v-model="userForm.userPhone" size="large" auto-complete="off" placeholder="请输入手机号" placeholder-style="color: green" :style="{ fontSize: '16px' }">
                <template #prefix>
            ...
            <el-form-item prop="userCaptcha" class="userCaptcha-main" label="验证码">
              <el-input v-model="userForm.userCaptcha" type="text" size="large" auto-complete="off" placeholder="验证码" placeholder-style="color: blue" :style="{ fontSize: '16px' }">
                <template #prefix>
            ...
            <el-form-item class="submit" id="login">
              <el-button size="large" color="#7b1e17" :style="{
                'background-color': !userForm.disableclick ? '#ccc' : '#7b1e17',
                ':hover': {
                  'background-color': !userForm.disableclick ? '#ccc' : 'hover-color' // 设置悬停颜色
                }
              }" :dark="isDark" class="btn_login" :disabled="!userForm.disableclick" @click="submitForm(ruleFormRef)">登录</el-button>
            </el-form-item>
          </el-tab-pane>
        </el-tabs>
      </el-form>
